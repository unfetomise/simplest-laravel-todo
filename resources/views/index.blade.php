        ...
        <div id="todos" class="my-5">
            <table class="table-auto">
                    ...
                    <tr class="bg-gray-50">
                        ...
                        <td><a href="/todos/{{ $todo->id }}/edit"><span class="p-2 m-1 bg-yellow-300 hover:bg-yellow-400 text-white rounded font-bold">ИЗМЕНИТЬ</span></a></td>
                        <td><form id="{{ $key.'f' }}" action="/todos/{{ $todo->id }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button id='good'
